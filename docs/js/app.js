        ...
        return <div>
            <div className="sideBar">
                <MZSidebar className="mz-fixed-left mz-dark"
                    ...
                    <MZNavbar className="mz-flex mz-dark mz-skinny mz-flex-align-stretch">
            ...
            <div>
                <MZNavbar className="mz-flex mz-dark mz-skinny mz-fixed-top mz-shadow mz-flex-align-stretch">
